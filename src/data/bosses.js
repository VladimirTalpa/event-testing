...
const BOSSES = {
  ...
  mahoraga: {
    ...
    rounds: [
      ...
      { type: "choice_qte", title: "Round 4 — Decide Fast", intro: "Choose quickly.\nPress the correct button for **3 seconds**.", windowMs: 3000,
        choices: [{ key: "slice", label: "Cutting", emoji: "⚔️" }, { key: "salmon", label: "Salmon!!", emoji: "🐟" }],
        correct: "slice",
        afterText: "🩸 Mahoraga took serious damage.",
        afterMedia: media.MAHO_R4_AFTER
      },
      { type: "scripted_hit_all", title: "Round 5 — Adaptation Begins", intro: "Why did the wheel on his head spin ?", media: media.MAHO_R5_WHEEL, delayMs: 5000,
        spamLines: [
      ...
      { type: "tri_press", title: "Round 7 — Regain Focus", intro: "Mahoraga takes over you.\nClick **all 3 buttons** for **12 seconds**, to get ready.", windowMs: 12 * 1000,
        buttons: [
      ...
      { type: "final_quiz", title: "Final — How to kill him?", intro: "...........", windowMs: 8000,
        choices: [
