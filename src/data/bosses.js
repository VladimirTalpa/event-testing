...
const BOSSES = {
  ...
  specialgrade: {
    ...
    rounds: [
      ...
      { type: "finisher", title: "Round 4 — Exorcism Window", intro: "Finish it! Press **Exorcise** in time.", windowMs: 5000, buttonLabel: "Exorcise", buttonEmoji: "🪬", media: media.JJK_SG_R3 },
    ],
  },
};
